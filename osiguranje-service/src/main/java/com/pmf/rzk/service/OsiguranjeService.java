...
public class OsiguranjeService {
	...
	public Osiguranje dodajOsiguranjeKupljenomAutu(Integer idUser, Integer idCarPurchase, Integer yearLength, Osiguranje o) {
		Optional<KupovinaAutomobil> optKupovina = kupovinaAutoRepo.findById(idCarPurchase);
	...
	public List<Osiguranje> vratiSpisakOsiguranja(Integer idUser) {
