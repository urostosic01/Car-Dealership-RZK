...
public class Clan implements Serializable {
	...
	@Size(min = 1, message = "Neophodno je uneti adresu!")
	private String adresa;

	@Size(min = 1, message = "Neophodno je uneti broj telefona!")
	private String brojTelefona;

	@Size(min = 1, message = "Neophodno je uneti ime!")
	private String ime;

	@Size(min = 1, message = "Neophodno je uneti korisnicko ime!")
	private String korisnickoIme;

	@Size(min = 1, message = "Neophodno je uneti prezime!")
	private String prezime;

	@Size(min = 1, message = "Neophodno je uneti sifru!")
